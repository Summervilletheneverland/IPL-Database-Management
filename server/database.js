...
const createdatabase=`CREATE DATABASE PROJECT;`
const createaccounts=`create table if not exists accounts(email varchar(50) primary key,username varchar(50),password varchar(50));
insert into accounts values('admin@gmail.com','admin','dbms');`
const createtable= `CREATE TABLE IF NOT EXISTS PLAYERS(PLAYER_ID INT PRIMARY KEY,PLAYER_NAME VARCHAR(50),DOB DATE,AGE INT,NATIONALITY VARCHAR(30),ROLE VARCHAR(20));

CREATE TABLE IF NOT EXISTS TEAMS(TEAM_ID CHAR(3) ,TEAM_NAME VARCHAR(50),SEASON_ID CHAR(3),HOME_GROUND VARCHAR(50),
TEAM_OWNER VARCHAR(50),COACH VARCHAR(50),PRIMARY KEY(TEAM_ID,SEASON_ID));

CREATE TABLE IF NOT EXISTS SEASON(SEASON_ID CHAR(3) PRIMARY KEY,YEAR INT,HOST VARCHAR(30),TITLE_SPONSOR VARCHAR(30),WINNER_ID CHAR(3),RUNNER_ID CHAR(3));

CREATE TABLE  IF NOT EXISTS POINTS_TABLE(TEAM_ID CHAR(3),SEASON_ID CHAR(3),MATCHES_PLAYED INT CHECK(MATCHES_PLAYED>-1),
      MATCHES_WON INT CHECK(MATCHES_WON>-1),MATCHES_LOST INT CHECK(MATCHES_LOST>-1),NO_RESULT INT CHECK(NO_RESULT>-1),NRR REAL,
      POINTS INT GENERATED ALWAYS AS (MATCHES_WON*2 + NO_RESULT)STORED CHECK(POINTS>-1),PRIMARY KEY(TEAM_ID,SEASON_ID));

CREATE TABLE IF NOT EXISTS AUCTION(AUCTION_ID CHAR(3),PLAYER_ID INT,SEASON_ID CHAR(3),BASE_PRICE INT ,
SOLD_PRICE INT CHECK(SOLD_PRICE>=BASE_PRICE),SOLD_TO CHAR(3),PRIMARY KEY(SEASON_ID,PLAYER_ID));
...
`
const alter_foreign_key=`ALTER TABLE AUCTION ADD CONSTRAINT AUCTION_SOLD_TO_SEASON_ID_FK  FOREIGN KEY (SOLD_TO,SEASON_ID) 
...
REFERENCES teams (team_id, season_id) ON UPDATE CASCADE ON DELETE CASCADE;`
/*ALTER TABLE PLAYERS ADD FOREIGN KEY(TEAM_ID,SEASON_ID) REFERENCES TEAMS(TEAM_ID,SEASON_ID);*/
/*ALTER TABLE AUCTION ADD FOREIGN KEY(SOLD_TO,SEASON_ID) REFERENCES TEAMS(TEAM_ID,SEASON_ID) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE AUCTION ADD FOREIGN KEY(PLAYER_ID) REFERENCES PLAYERS(PLAYER_ID) ON UPDATE CASCADE ON DELETE CASCADE;*/
/*ALTER TABLE AUCTION ADD FOREIGN KEY(SEASON_ID) REFERENCES SEASON(SEASON_ID);*/
/*ALTER TABLE POINTS_TABLE ADD FOREIGN KEY(TEAM_ID,SEASON_ID) REFERENCES TEAMS(TEAM_ID,SEASON_ID) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE BOWLING_PERFORMANCE ADD FOREIGN KEY(PLAYER_ID,SEASON_ID) REFERENCES AUCTION(PLAYER_ID,SEASON_ID) ON UPDATE CASCADE ON DELETE CASCADE;*/
/*ALTER TABLE BOWLING_PERFORMANCE ADD FOREIGN KEY(PLAYER_ID) REFERENCES PLAYERS(PLAYER_ID);*/
/*ALTER TABLE FIELDING_PERFORMANCE ADD FOREIGN KEY(PLAYER_ID,SEASON_ID) REFERENCES AUCTION(PLAYER_ID,SEASON_ID) ON UPDATE CASCADE ON DELETE CASCADE;*/
/*ALTER TABLE FIELDING_PERFORMANCE ADD FOREIGN KEY(PLAYER_ID) REFERENCES PLAYERS(PLAYER_ID);*/
/*ALTER TABLE BATTING_PERFORMANCE ADD FOREIGN KEY(PLAYER_ID,SEASON_ID) REFERENCES AUCTION(PLAYER_ID,SEASON_ID) ON UPDATE CASCADE ON DELETE CASCADE;*/
/*ALTER TABLE BATTING_PERFORMANCE ADD FOREIGN KEY(PLAYER_ID) REFERENCES PLAYERS(PLAYER_ID);*/

const createfunctionage=`CREATE OR REPLACE FUNCTION FUNCTION_AGE()
...
const createtriggerage=`CREATE TRIGGER TRIGGER_AGE AFTER INSERT ON PLAYERS
FOR EACH ROW EXECUTE PROCEDURE FUNCTION_AGE();`

const insertion_season=`INSERT INTO SEASON (SEASON_ID, YEAR, HOST, TITLE_SPONSOR) VALUES ('S01', 2008, 'INDIA', 'DLF');
...
`
const insertion_teams=`INSERT INTO TEAMS (TEAM_ID, TEAM_NAME, SEASON_ID, HOME_GROUND, TEAM_OWNER, COACH)
...
const insertion_season_foreign=`alter table season add foreign key(runner_id,season_id) references teams(team_id,season_id);
alter table season add foreign key(winner_id,season_id) references teams(team_id,season_id);
`
const insertion_pointstable=`INSERT INTO POINTS_TABLE (TEAM_ID, SEASON_ID, MATCHES_PLAYED, MATCHES_WON, MATCHES_LOST, NO_RESULT, NRR)
...
const insertion_players=`INSERT INTO PLAYERS (PLAYER_ID, PLAYER_NAME, DOB, NATIONALITY, ROLE)
VALUES
...
const insertion_auction=`INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A01', 1, 'S01', 300000, 350000, 'T04');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A02', 2, 'S01', 400000, 450000, 'T08');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A03', 3, 'S01', 350000, 370000, 'T01');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A04', 4, 'S01', 320000, 360000, 'T06');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A05', 5, 'S01', 380000, 400000, 'T08');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A06', 6, 'S01', 300000, 330000, 'T02');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A07', 7, 'S01', 500000, 550000, 'T03');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A08', 8, 'S01', 310000, 340000, 'T06');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A09', 9, 'S01', 450000, 480000, 'T06');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A10', 10, 'S01', 470000, 490000, 'T01');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A11', 11, 'S01', 440000, 460000, 'T08');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A12', 12, 'S01', 300000, 350000, 'T07');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A13', 13, 'S01', 320000, 340000, 'T02');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A14', 14, 'S01', 310000, 360000, 'T03');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A15', 15, 'S01', 300000, 350000, 'T07');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A16', 16, 'S01', 330000, 360000, 'T07');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A17', 17, 'S01', 350000, 380000, 'T02');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A18', 18, 'S01', 300000, 340000, 'T05');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A19', 19, 'S01', 450000, 470000, 'T03');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A20', 20, 'S01', 320000, 350000, 'T06');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A21', 21, 'S01', 340000, 370000, 'T06');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A22', 22, 'S01', 360000, 400000, 'T07');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A23', 23, 'S01', 330000, 360000, 'T08');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A24', 24, 'S01', 340000, 380000, 'T01');
INSERT INTO AUCTION (AUCTION_ID, PLAYER_ID, SEASON_ID, BASE_PRICE, SOLD_PRICE, SOLD_TO) VALUES ('A25', 25, 'S01', 300000, 350000, 'T08');
